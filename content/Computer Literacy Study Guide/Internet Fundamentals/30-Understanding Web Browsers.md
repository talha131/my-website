...
<div style="margin:40px 0; text-align:center;">
  <div style="display:inline-block; padding:6px 28px; background:#AAC4F5; border-radius:10px;">
        <h2 style="margin:0;border:none">Examples</h2>
  </div>
</div>

<p style="display:inline-flex; align-items:center; gap:6px;margin-top:0px">
<img src="/images/logo-chrome.svg" alt="Google Chrome logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Google Chrome</strong>: The most popular browser in the world.
</p>

<p style="display:inline-flex; align-items:center; gap:6px;;margin-top:0px">
<img src="/images/logo-firefox.svg" alt="Mozilla Firefox logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Mozilla Firefox</strong>: A browser that is well-known for its strong privacy features.
</p>

<p style="display:inline-flex; align-items:center; gap:6px;;margin-top:0px">
<img src="/images/logo-edge.svg" alt="Microsoft Edge logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Microsoft Edge</strong>: The browser made by Microsoft that comes with Windows.
</p>

<p style="display:inline-flex; align-items:center; gap:6px;;margin-top:0px">
<img src="/images/logo-safari.svg" alt="Apple Safari logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Apple Safari</strong>: The browser made by Apple for its Mac computers and iPhones.
</p>

<p style="display:inline-flex; align-items:center; gap:6px;;margin-top:0px">
<img src="/images/logo-opera.svg" alt="Opera logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Opera</strong>: A browser that includes unique features like a free built-in VPN.
</p>

<p style="display:inline-flex; align-items:center; gap:6px;;margin-top:0px">
<img src="/images/logo-brave.svg" alt="Brave logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Brave</strong>: A browser focused on privacy that automatically blocks ads and trackers.
</p>

<p style="display:inline-flex; align-items:center; gap:6px;;margin-top:0px">
<img src="/images/logo-vivaldi.svg" alt="Vivaldi logo" width="24" height="24"   style="display:inline-block; vertical-align:middle; margin-right:6px;"
/>
<strong>Vivaldi</strong>: A browser that is highly customizable, letting users change how it looks and works.
</p>
